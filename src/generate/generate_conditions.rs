    ...
    fn generate_condition_ex(
                    ...
                    match operator {
                        ...
                        _ => {
                            ...
                            if self.saved_y {
                                return Err(self
                                    .compiler_state
                                    .syntax_error("Code too complex for the compiler. Please split line into several statements", pos));
                            }
        ...
        match left {
            ...
            _ => {
                return Err(self
                    .compiler_state
                    .compiler_error("Condition statement is partially implemented", pos));
            }
        }
        ...
        if self.saved_y {
            return Err(self.compiler_state.syntax_error(
                "Code too complex for the compiler. Please split line into several statements",
                pos,
            ));
        }
